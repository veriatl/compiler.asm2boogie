...
<asm version="1.0" name="0">
	<cp>
		...
		<constant value="A.__matcha2x():V"/>
		<constant value="__exec__"/>
		<constant value="a2x"/>
		<constant value="NTransientLinkSet;.getLinksByRule(S):QNTransientLink;"/>
		<constant value="A.__applya2x(NTransientLink;):V"/>
		<constant value="b2y"/>
		<constant value="A.__applyb2y(NTransientLink;):V"/>
		<constant value="c2z"/>
		<constant value="A.__applyc2z(NTransientLink;):V"/>
		<constant value="__matcha2x"/>
		<constant value="IN"/>
	...
	<operation name="49">
		...
		<localvariabletable>
			<lve slot="1" name="57" begin="6" end="90"/>
